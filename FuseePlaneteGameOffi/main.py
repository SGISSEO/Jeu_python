...
while not ARRET_JEU:
    ...
    ECRAN.blit(IMG_PLANETE_DROITE, (XX_PLANETE + XX_ENTRE_PLANETES, YY_PLANETE + YY_ENTRE_PLANETES))
        ...
        if POINT_BAS_DROIT_PREMIERE_PLANETE_X > XX_FUSEE:
            if POINT_BAS_DROIT_PREMIERE_PLANETE_Y > YY_FUSEE:
                if POINT_BAS_DROIT_PREMIERE_PLANETE_Y < YY_FUSEE + HAUTEUR_FUSEE:
                    ...
                    POINT_BAS_GAUCHE_DEUXIEME_PLANETE_Y = YY_PLANETE + YY_ENTRE_PLANETES + HAUTEUR_PLANETE
